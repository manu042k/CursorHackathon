...
RESEARCH_MIN_KEEP = 4
RESEARCH_MAX_AGE_DAYS = 540
RESEARCH_MIN_SCORE = 10
RESEARCH_MIN_COMMENTS = 3
RESEARCH_MAX_ITEMS_PER_SOURCE = 8
BRAVE_SEARCH_API_KEY = os.environ.get("BRAVE_SEARCH_API_KEY", "")
TAVILY_API_KEY = os.environ.get("TAVILY_API_KEY", "")
SEARCH_PROVIDER = os.environ.get("SEARCH_PROVIDER", "auto").strip().lower() or "auto"
