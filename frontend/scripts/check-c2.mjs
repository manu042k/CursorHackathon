...
const checks = [
  ...
  [form.includes("price_change"), "price_change offered"],
  [form.includes("competitor_entry"), "competitor_entry offered"],
  [form.includes("marketing_spend"), "marketing_spend offered"],
  [form.includes("feature_change"), "feature_change offered"],
